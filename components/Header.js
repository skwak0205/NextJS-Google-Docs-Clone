...
const Header = () => {
  return (
    <section className='sticky top-0 z-50 flex items-center px-4 py-2 shadow-md bg-white'>
      <Button
        color='gray'
        buttonType='outline'
        rounded={true}
      ...
      <img
        loading='lazy'
        src='https://lh3.googleusercontent.com/ogw/ADea4I7fUwq5gjrt3CNl8mvmTtOB3jFyGhipeJDWORYtbw=s32-c-mo'
        alt='pic'
